...
namespace Mobiray.Numbers
{
	...
	public class BigInteger
	{
		...
		public static BigInteger Multiply(BigInteger leftSide, float factor, int shape = 1000) {
			BigInteger rightSide = (int) (factor * shape);
			return leftSide * rightSide / shape;
		}

		/*
		 * return value * basis ^ pow
		 */
		public static BigInteger Pow(BigInteger value, int pow, int basis = 10) {
